...
for j in $(tail -n +2 ../../conditions.txt) #pour toutes les lignes à partir de la deuxième
do
    ...
    ascp -QT --file-checksum=md5 --file-manifest=text --file-manifest-path=. -l 300m -P33001 -i /home/marine.aglave/anaconda3/envs/FAIR/etc/asperaweb_id_dsa.openssh ${access} .
